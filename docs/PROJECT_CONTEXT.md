...
- Popup unico con:
  ...
  - Panel embebido asocia automaticamente chat -> lead priorizando telefono y memoria de contexto por workspace (fallback por nombre unico), y autocompleta telefono al guardar leads nuevos cuando el chat expone numero.
